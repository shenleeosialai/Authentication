...
SECRET_KEY = 'django-insecure-*@anhxb-!uu04*urm!6x@m3-^0$5*5*sf((fm2!x4bg3x3xc6n'
...
SOCIAL_AUTH_GITHUB_CLIENT_ID = config('GITHUB_CLIENT_ID')
SOCIAL_AUTH_GITHUB_CLIENT_SECRET = config('GITHUB_CLIENT_SECRET')
